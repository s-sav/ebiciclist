...
if(isset($_POST['add_to_wishlist'])){
   ...
   if($check_wishlist_numbers->rowCount() > 0){
      $message[] = 'produs deja adăugat în favorite!';
   }elseif($check_cart_numbers->rowCount() > 0){
      $message[] = 'produs deja adăugat in coș!';
   }else{
      $insert_wishlist = $conn->prepare("INSERT INTO `wishlist`(user_id, pid, name, price, image) VALUES(?,?,?,?,?)");
      $insert_wishlist->execute([$user_id, $pid, $p_name, $p_price, $p_image]);
      $message[] = 'adăugat cu succes în favorite!';
   }
...
<section class="p-category">
   <a href="categorii.php?category=biciclete" <?php echo (isset($_GET['category']) && $_GET['category'] == 'biciclete') ? 'class="selected-category"' : ''; ?>>biciclete</a>
   <a href="categorii.php?category=piese" <?php echo (isset($_GET['category']) && $_GET['category'] == 'piese') ? 'class="selected-category"' : ''; ?>>piese</a>
   <a href="categorii.php?category=accesorii" <?php echo (isset($_GET['category']) && $_GET['category'] == 'accesorii') ? 'class="selected-category"' : ''; ?>>accesorii</a>
   <a href="categorii.php?category=echipamente" <?php echo (isset($_GET['category']) && $_GET['category'] == 'echipamente') ? 'class="selected-category"' : ''; ?>>echipamente</a>
</section>
...
<section class="products">
   ...
   <?php
         ...
         echo '<p class="empty">Nu este disponibil nici un produs!</p>';
      }
   ?>
   </div>
</section>
