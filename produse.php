...
if(isset($_POST['add_to_wishlist'])){
   ...
   if($check_wishlist_numbers->rowCount() > 0){
      $message[] = 'produs deja adăugat în wishlist!';
   }elseif($check_cart_numbers->rowCount() > 0){
      $message[] = 'produs deja adăugat în coș!';
   }else{
      $insert_wishlist = $conn->prepare("INSERT INTO `wishlist`(user_id, pid, name, price, image) VALUES(?,?,?,?,?)");
      $insert_wishlist->execute([$user_id, $pid, $p_name, $p_price, $p_image]);
      $message[] = 'produs adaugat la wishlist!';
   }
...
if(isset($_POST['add_to_cart'])){
   ...
   if($check_cart_numbers->rowCount() > 0){
      $message[] = 'produs deja adaugat în coș!';
   }else{
...
<section class="p-category">
   ...
   <a href="categorii.php?category=biciclete" >biciclete</a>
   <a href="categorii.php?category=piese">piese</a>
   <a href="categorii.php?category=accesorii">accesorii</a>
   <a href="categorii.php?category=echipamente">echipamente</a>
