...
if(isset($_POST['add_to_wishlist'])){
   ...
   if($check_wishlist_numbers->rowCount() > 0){
      $message[] = 'produs deja adăugat in wishlist!';
...
if(isset($_POST['add_to_cart'])){
   ...
   if($check_cart_numbers->rowCount() > 0){
      $message[] = 'produs deja adaugat in cos!';
   }else{
...
<section class="search-form">
   ...
   <form action="" method="POST">
      <input type="text" class="box" name="search_box" placeholder="caută produse pe site...">
      <input type="submit" name="search_btn" value="Caută" class="btn">
   </form>
...
<section class="products" style="padding-top: 0; min-height:100vh;">
   <div class="box-container">
      ...
      <?php
               ...
               $message[] = 'Nu au fost găsite rezultate!';
            }
      }
